...
//     lhs: LikeString<TokenStream>,
//     rhs: LikeString<TokenStream>,
// }

// pub enum DoopItem {
//     TokensAssignment(DoopItemBinding),
//     ListAssignment(DoopItemBinding),
//     GeneratingBlock(Vec<DoopItemBinding>, LikeString<TokenStream>),
// }

// pub fn parse(input: &LikeString<TokenStream>) -> Result<Vec<DoopItem>,
// LikeString<TokenStream>> {     let mut items = Vec::new();
...
//                 rhs: LikeString<TokenStream>,
//             },
//             TokensListAssignment {
//                 lhs: Ident,
//                 rhs: LikeString<TokenStream>,
//             },
//             EmitForLoop {
//                 body: LikeString<TokenStream>,
//                 bindings: Vec<(LikeString<TokenStream>,
// LikeString<TokenStream>)>,             },
//         }
...
//                 let body: LikeString<TokenStream>;
//                 loop {
//                     match iter.peek() {
...
//                         }
//                         Some(tree) => {
//                             return TokenTree::clone(tree).error(
//                                 "expected
// `for` keyword",
//                             );
//                         }
...
//                             return tree.clone().error(
//                                 "expected identifier or tuple binding
// target",
//                             );
//                         }
//                         None =>
...
//                     let mut token_list = LikeString::<TokenStream>::new();
